...
The Tender must contain documents according to the procedure as ESPD, Pre-award catalogue and other structured and unstructured document along the requirements defined by the contracting authority. The contracting body notifies the economic operator of having received the Tender. +
